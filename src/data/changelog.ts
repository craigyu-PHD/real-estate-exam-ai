...
export const releaseLog:ReleaseEntry[]=[
  {version:'2.3.0',date:'規劃中',title:'教材人工抽驗 × 題庫持續擴充',status:'planned',progress:0,summary:'下一階段以人工法律內容抽驗、歷屆題擴充與雲端同步為核心。',highlights:['教材分層人工抽驗','更多歷屆與情境題','使用者修訂紀錄與雲端同步']},
  {version:'2.2.0',date:'2026-08-26',title:'2,399 條教材 × AI Context × Theme Engine',status:'current',progress:100,summary:'重建法條資料與教材層，讓每條法規都有預先產生的客製教材、Mini Lecture 與可追問 AI，並加入完整題庫篩選與五套原創主題。',highlights:['12 部法規共 2,399 條，修正章節污染','2,399 份唯一教材與 Mini Lecture QA','Article AI Drawer 自動帶入當前條文','50 題題庫＋題量／章節／狀態／題型篩選','System／Light／Dark × 五套原創 Theme Pack']},
