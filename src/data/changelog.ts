...
export const releaseLog:ReleaseEntry[]=[
  {version:'2.5.0',date:'規劃中',title:'PWA 現代化 × 教材人工抽驗 × 雲端同步',status:'planned',progress:0,summary:'下一階段集中清理舊 PWA/Workbox 依賴、建立高頻教材人工審核流程，並強化跨裝置同步。',highlights:['替換舊 next-pwa 依賴鏈','高頻法條人工抽驗與核准標章','學習資料跨裝置同步']},
  {version:'2.4.0',date:'2026-08-26',title:'企業級 UI × Podcast 深化 × AI 多路備援',status:'current',progress:100,summary:'把學習頁、AI 老師與聽課模式進一步產品化：內容攤開、全法播放清單、完整 Podcast 腳本與永不中斷的教材型 AI 備援。',highlights:['C／D 教學卡固定展開並等高呈現','Gemini／Groq／Mistral／OpenRouter／Hugging Face 五路 AI＋Local Tutor','暗黑模式提高卡片、框線、標題與功能鍵層級','聽課播放器縮小並與完整播放清單並排','完整法條清單＋每 10 條進度起點','Podcast 統一為原文→白話→目的→案例→考點','東京 Serverless 優先區域＋Edge 音訊 CDN 快取']},
