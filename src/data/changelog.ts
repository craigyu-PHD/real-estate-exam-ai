...
export const releaseLog:ReleaseEntry[]=[
  {version:'2.6.0',date:'規劃中',title:'PWA 現代化 × 教材人工抽驗 × 雲端同步',status:'planned',progress:0,summary:'下一階段集中清理舊 PWA/Workbox 依賴、建立高頻教材人工審核流程，並強化跨裝置同步。',highlights:['替換舊 next-pwa 依賴鏈','高頻法條人工抽驗與核准標章','學習資料跨裝置同步']},
  {version:'2.5.0',date:'2026-08-26',title:'主題美術重製 × SVG 插畫 × 互動特效',status:'current',progress:100,summary:'把五套 Theme Pack 從幾何換色升級成真正的原創美術系統，加入專屬插畫、背景與點擊／換頁互動語言。',highlights:['蛛網英雄：多層蛛網＋原創網紋英雄徽章','極速賽道：原創賽車＋賽道＋格紋旗','深空指揮艦：原創星艦＋雷達 HUD＋星圖背景','Iron Forge／Shadow Ronin 同步加入專屬機械與刀鋒插畫','五套主題各自擁有 SVG 點擊特效、游標與換頁動畫','10 個原創 SVG 美術資產，無外部圖片授權依賴']},
  {version:'2.4.0',date:'2026-08-26',title:'企業級 UI × Podcast 深化 × AI 多路備援',status:'completed',progress:100,summary:'把學習頁、AI 老師與聽課模式進一步產品化：內容攤開、全法播放清單、完整 Podcast 腳本與永不中斷的教材型 AI 備援。',highlights:['C／D 教學卡固定展開並等高呈現','Gemini／Groq／Mistral／OpenRouter／Hugging Face 五路 AI＋Local Tutor','暗黑模式提高卡片、框線、標題與功能鍵層級','聽課播放器縮小並與完整播放清單並排','完整法條清單＋每 10 條進度起點','Podcast 統一為原文→白話→目的→案例→考點','東京 Serverless 優先區域＋Edge 音訊 CDN 快取']},
  {version:'2.3.0',date:'2026-08-26',title:'教材深度 × Natural TTS × Performance',status:'completed',progress:100,summary:'針對土地法教材空泛、AI 快捷功能分散、語音等待與播放清單不同步進行品質與效能重構。',highlights:['土地法 262 條專用制度型教材＋高頻條文深度教材','AI Drawer 六個快捷問題與 Gemini/Groq/OpenRouter 備援','免 Key Edge Neural 台灣聲線＋串流播放','聽課防連點、預抓下一條、播放 session 失效機制','聽課版面與播放清單同步修正','Iron Forge 與五套主題商業化配色微調']},
